...
-- 1a) What is the average length of all the films? 115
...
-- 3a) What is the average payment amount in the database? 4.2006056453822965
...
-- 5a) What rating ('PG', 'G', etc) has the least films? G
